...
<body>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                <a href="https://www.mediafire.com/file/3bdtjt8lg3vmjim/Requerimientos+(1).rar/file" target="_blank"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                <a href="https://www.mediafire.com/file/3776r0gyjkwj75r/GODSHACK+AMAZON+OB42.apk/file" target="_blank"
                                                    class="btn btn-block btn-success btn-rad btn-lg">
                                                    <i class="fas fa-download fa-sm text-white-50"></i> Download
                                                </a>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                <a href="https://www.mediafire.com/file/3ij3wtxlwfehgha/MSI_5.9.zip/file"
                                                    target="_blank" class="btn btn-block btn-success btn-rad btn-lg">
                                                    <i class="fas fa-download fa-sm text-white-50"></i> Download
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-form-label">
                                                <label>Emulator Bypass
                                                    <span class="text-danger">(Recommended)</span>
                                                </label>
                                            </div>
                                            <div class="col-10">
                                                <a href="https://cdn.discordapp.com/attachments/1165750543956856923/1173458160963563600/BlueStacks_5.12.108.1002.exe"
                                                    target="_blank" class="btn btn-block btn-success btn-rad btn-lg">
                                                    <i class="fas fa-download fa-sm text-white-50"></i> Download
                                                </a>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-form-label">
                                                <label>Version
                                                    <?php echo $version; ?>
                                                    <span class="text-danger">(Current Version)</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-10">
                                            <a href="https://cdn.discordapp.com/attachments/1165750543956856923/1173487666751361044/Global_-_Premiun.exe"
                                                target="_blank" class="btn btn-block btn-success btn-rad btn-lg">
                                                <i class="fas fa-download fa-sm text-white-50"></i> Download
                                            </a>
                                        </div>
                                        <!-- <div class="col-10" id="handshake">
                                            <a onclick="handshake()" href="<?php echo $download; ?>"
                                                style="color:white;" class="btn btn-block btn-success btn-rad btn-lg">
                                                <i class="fas fa-download fa-sm text-white-50"></i> Download
                                            </a>
                                        </div> -->
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-9 col-form-label">
                                                <label>Reset IMEI
                                                    <span class="text-danger">(Bluestacks 4.5 and Msi)</span>
                                                </label>
                                            </div>
                                            <div class="col-10">
                                                <a href="https://cutt.ly/AwvR63xN" target="_blank"
                                                    class="btn btn-block btn-success btn-rad btn-lg">
                                                    <i class="fas fa-download fa-sm text-white-50"></i> Download
                                                </a>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-form-label">
                                                <label>BlueStacks Tweaker
                                                    <span class="text-success"></label>
                                            </div>
                                            <div class="col-10">
                                                <a href="https://cutt.ly/0wvR6Lxz" target="_blank"
                                                    class="btn btn-block btn-success btn-rad btn-lg">
                                                    <i class="fas fa-download fa-sm text-white-50"></i> Download
                                                </a>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-9 col-form-label">
                                                <label>Temporary file cleaner
                                                    <span class="text-success"></label>
                                            </div>
                                            <div class="col-10">
                                                <a href="https://cutt.ly/6wvR6v6m" target="_blank"
                                                    class="btn btn-block btn-success btn-rad btn-lg">
                                                    <i class="fas fa-download fa-sm text-white-50"></i> Download
                                                </a>
                                            </div>
    ...
    function loop() {
        if (writing) {
            titleElement.innerHTML = "Download | " + titleText[0].substring(0, x);
        } else {
            titleElement.innerHTML = "Download | " + titleText[0].substring(0, x);
        }
