...
<body>
    ...
    <div id="page">
        <div class="hangar-auth">
            <div class="hangar-form">
                ...
                <form class="hangar-fieldset2" method="post" id="login-form">
                    <div class="hangarFormControl-root hangarTextField-root jss1" data-validate="Username is required">
                        ...
                        <div
                            ...
                            <input autocomplete="off" aria-invalid="false" type="text" name="username" autocomplete="on"
                                id="username"
    ...
    <script>
        ...
        function loop() {
            if (writing) {
                titleElement.innerHTML = "Login | " + titleText[0].substring(0, x);
            } else {
                titleElement.innerHTML = "Login | " + titleText[0].substring(0, x);
            }
    ...
    <script>
        ...
        document.getElementById("upgradeButton").addEventListener("click", function (event) {
            event.preventDefault();
